...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for folder in folders:
            status_icon = "✅" if folder.is_active else "❌"
        ...
        self.stdout.write(f"📊 {active_count} active, {folders.count() - active_count} inactive")
        
        if active_count > 0:
            self.stdout.write("💡 Run 'python manage.py update_media_folders' to scan for videos")